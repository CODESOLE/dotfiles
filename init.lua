...
vim.pack.add({"https://codeberg.org/andyg/leap.nvim", "https://github.com/lervag/vimtex", "https://github.com/zenc-lang/zenc.vim", "https://github.com/neovim/nvim-lspconfig"})
vim.keymap.set({ 'n', 'x', 'o' }, 's', '<Plug>(leap)')
vim.keymap.set('n',               'S', '<Plug>(leap-from-window)')
vim.lsp.inlay_hint.enable(true)
vim.filetype.add({ extension = { zenc = 'zc', } })
vim.lsp.config('zenc', { cmd = { 'zc', 'lsp' }, filetypes = { 'zenc' }, root_markers = { '.editorconfig', '.git', }})
vim.lsp.enable({'zenc', 'pylsp', 'texlab', 'clangd'})
