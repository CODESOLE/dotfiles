...
vim.keymap.set({ 'n', 't' }, '<C-k>', '<C-\\><C-N>:tabnext<CR>', {silent = true, noremap = true})
...
vim.pack.add({"https://github.com/bluz71/vim-moonfly-colors","https://github.com/lervag/vimtex","https://github.com/neovim/nvim-lspconfig"})
